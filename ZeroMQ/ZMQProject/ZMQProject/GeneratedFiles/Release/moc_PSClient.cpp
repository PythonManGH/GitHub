...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_PSClient_t, stringdata0) + ofs \
...
void PSClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PSClient::value)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject PSClient::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_PSClient.data,
...
void *PSClient::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PSClient.stringdata0))
...
// SIGNAL 0
void PSClient::value(QString _t1)
{
