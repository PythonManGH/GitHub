...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_PSServer_t, stringdata0) + ofs \
...
void PSServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (PSServer::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PSServer::value)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject PSServer::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_PSServer.data,
...
void *PSServer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PSServer.stringdata0))
...
// SIGNAL 0
void PSServer::value(QString _t1)
{
